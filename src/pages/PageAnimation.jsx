          ...
          {animations.map((animation, index) => {
            ...
            return (
              <button
                ...
                className={`shrink-0 cursor-pointer rounded-lg border-0 px-4 py-2.5 text-xs font-semibold transition-all duration-200 sm:px-5 sm:text-sm ${isActive ? "bg-white text-[#111] shadow-[0_2px_10px_rgba(0,0,0,0.08)]" : "bg-transparent text-[#666] hover:bg-white/50 hover:text-[#111]"}`}
              >
                {animation.name}
              </button>
            );
              ...
              {currentAnimation.files.map((file, index) => {
                ...
                return (
                  <button
                    ...
                    className={`relative shrink-0 cursor-pointer border-0 border-r border-[#e5e5e5] px-4 font-mono text-xs transition-all duration-200 sm:px-6 sm:text-sm ${isActive ? "bg-white font-semibold text-[#111]" : "bg-[#fafafa] text-[#777] hover:bg-[#f3f3f3] hover:text-[#222]"}`}
                  >
                    {file.name}
